...
export default function ChatView() {
  ...
  const EmptyState = (
    <div className="flex flex-1 items-center justify-center">
      <div className="w-full max-w-md rounded border border-slate-700 bg-slate-900 p-8 text-center shadow-sm">
      ...
      if (dayKey !== lastDate) {
        out.push(
          <div key={`sep-${i}`} className="flex justify-center py-2">
            <span className="rounded bg-slate-800 px-3 py-1 text-xs text-slate-300">
  ...
  return (
    <div className="flex flex-1 flex-col">
      <div className="flex items-center gap-3 border-b border-white/5 bg-[#0b0c0f] px-4 py-3">
        ...
        <div className="flex items-center gap-3 text-slate-300">
          <button aria-label="video" className="rounded p-2 hover:bg-white/5">
            🎥
          </button>
          <button aria-label="search" className="rounded p-2 hover:bg-white/5">
            🔍
          </button>
          <button aria-label="more" className="rounded p-2 hover:bg-white/5">
            ⋮
          </button>
        </div>
      </div>

      <div className="flex-1 space-y-4 overflow-y-auto bg-[#0f1115] p-4">
